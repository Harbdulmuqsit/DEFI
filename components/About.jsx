...
const About = () => {
  return (
    ...
    <div>
          ...
          {/*card*/}   
          <AboutCard icon={<SiHiveBlockchain size={40} />} heading='Reliable, tamper-proof network' 
          ...
          <AboutCard icon={<SiFsecure size={40} />} heading='Seamless connection to any API' 
          ...
          <AboutCard icon={<SiStrapi size={40} />} heading='Proven, ready-made solutions' 
          ...
          <AboutCard icon={<VscServerProcess size={40} />} heading='Secure off-chain computation' 
